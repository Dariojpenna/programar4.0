<?php
    ...
    //  $id_usuario=$_SESSION['id_usuario'];
        ...
        $instruccion="insert into usuarios (nombre,apellido,usuario,password) values ('$nombre','$apellido','$usuario','$contrasena_encriptada')";
        ...
        header("location:usuarios.php?mensaje=Usuariu guradado con exito");
    ...
    /*header("location:nuevo_usuario.php?mensaje=" . urlencode($mensaje) . "&otraVariable=" . urlencode($otraVariable) . "&nombre=" . urlencode($nombre));
*/
